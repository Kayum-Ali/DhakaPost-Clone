...
const EntertainmentData = ({data}) => {
    ...
    return (
        <div className='col-span-5'>
             <Link to={`/entertainment/${id}`}  className=" grid grid-cols-5 py-2  singleNews lg:border-r border-r-gray-500 lg:pr-3 md:border-r md:pr-3 border-b border-b-gray-500 p-3">
